package com.jianzj.ticket.service.frameworks.starter.database.algorithm.sharding;
 ...
 * 自定义数据库分片算法
 */
public final class CustomDbShardingAlgorithm implements StandardShardingAlgorithm<Comparable<?>> {
