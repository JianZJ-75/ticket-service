...
/**
 * @Author JianZJ
 * @Date 2025/2/18 20:19
 */

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import com.alibaba.fastjson2.JSON;
import com.jianzj.ticket.service.frameworks.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.jianzj.ticket.service.frameworks.starter.log.annotation.ILog) || @annotation(com.jianzj.ticket.service.frameworks.starter.log.annotation.ILog)")
