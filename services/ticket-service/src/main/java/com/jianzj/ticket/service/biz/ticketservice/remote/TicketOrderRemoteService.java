...
import com.jianzj.ticket.service.biz.ticketservice.remote.dto.TicketOrderCreateRemoteReqDTO;
 ...
 * 车票订单远程服务调用
 */
@FeignClient(value = "ticket-service-order${unique-name:}-service", url = "http://127.0.0.1:${server.port}")
